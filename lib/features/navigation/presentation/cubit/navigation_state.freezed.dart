...
mixin _$NavigationState {
 ...
 int get selectedIndex; bool get isHolding;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NavigationState&&(identical(other.selectedIndex, selectedIndex) || other.selectedIndex == selectedIndex)&&(identical(other.isHolding, isHolding) || other.isHolding == isHolding));
}


@override
int get hashCode => Object.hash(runtimeType,selectedIndex,isHolding);

@override
String toString() {
  return 'NavigationState(selectedIndex: $selectedIndex, isHolding: $isHolding)';
}
...
@useResult
$Res call({
 int selectedIndex, bool isHolding
});
...
/// Create a copy of NavigationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedIndex = null,Object? isHolding = null,}) {
  return _then(_self.copyWith(
selectedIndex: null == selectedIndex ? _self.selectedIndex : selectedIndex // ignore: cast_nullable_to_non_nullable
as int,isHolding: null == isHolding ? _self.isHolding : isHolding // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int selectedIndex,  bool isHolding)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NavigationState() when $default != null:
return $default(_that.selectedIndex,_that.isHolding);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int selectedIndex,  bool isHolding)  $default,) {final _that = this;
switch (_that) {
case _NavigationState():
return $default(_that.selectedIndex,_that.isHolding);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int selectedIndex,  bool isHolding)?  $default,) {final _that = this;
switch (_that) {
case _NavigationState() when $default != null:
return $default(_that.selectedIndex,_that.isHolding);case _:
  return null;
...
class _NavigationState implements NavigationState {
  const _NavigationState({this.selectedIndex = 0, this.isHolding = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NavigationState&&(identical(other.selectedIndex, selectedIndex) || other.selectedIndex == selectedIndex)&&(identical(other.isHolding, isHolding) || other.isHolding == isHolding));
}
...
/// Create a copy of NavigationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedIndex = null,Object? isHolding = null,}) {
