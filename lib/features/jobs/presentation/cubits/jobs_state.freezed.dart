...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<JobModel>? jobs)?  loaded,TResult Function( String message)?  error,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<JobModel>? jobs)  loaded,required TResult Function( String message)  error,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<JobModel>? jobs)?  loaded,TResult? Function( String message)?  error,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements JobsState {
  const _Loaded(final  List<JobModel>? jobs): _jobs = jobs;
...
@override
String toString() {
  return 'JobsState.loaded(jobs: $jobs)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $JobsStateCopyWith<$Res> {
...
/// Create a copy of JobsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? jobs = freezed,}) {
  return _then(_Loaded(
freezed == jobs ? _self._jobs : jobs // ignore: cast_nullable_to_non_nullable
as List<JobModel>?,
  ));
}
...
class _Error implements JobsState {
...
class _Empty implements JobsState {
  const _Empty();
